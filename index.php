        ...
        <div class="container">
            <div class="header__inner">
                ...
                <nav class="nav" id="nav">
                    ...
                    <a class="nav__link" href="Authorin.php">Отзывы</a>
                    <a class="nav__link" href="#" data-modal="#modal_contact">Контакты</a>
                    <a class="nav__link nav__link--btn" href="Authorin.php">Войти</a>
                </nav>
...
<section class="intro">
    <div class="container">
        <div class="intro__inner">
           ...
           <!--<img class="intro__photo" src="assets/images/photo_fon.jpg"  style="background:right  no-repeat" alt="">-->
        </div><!--/.intro__inner-->
    </div><!--/.container-->
</section>
