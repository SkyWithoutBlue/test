...
<section class="intro">
    <div class="container">
        <div class="intro__inner">
           ...
           <!--<img class="intro__photo" src="assets/images/photo.png" alt="">-->
        </div><!--/.intro__inner-->
    </div><!--/.container-->
</section>
...
<div class="works">
    <div class="container">
            ...
            <?php
                    ...
                    foreach($res as $item){
                        printf(
                            ...
                            <a href="updateProject.php?id=<?= $works[`id`] ?>" class="btn" type="button" style= "padding:10px">Изменить</a>
                        </div>
     ...
     <a href="deleteProject.php?id=<?= $works[`id`] ?>" class="btn" type="button" style= "padding:10px">Удалить</a>-->
</div><!--/.works-->
